  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        transition={{ duration: 1 }}
      >
        <Image src="/assets/fayn99xMACFit-54.jpg" alt="Izmir Fashion Week" layout="fill" objectFit="cover" />
      </motion.div>
