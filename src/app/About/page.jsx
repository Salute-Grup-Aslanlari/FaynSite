...
const AboutUs = () => {
    ...
    <div className="mb-96">
      <div className="flex flex-col lg:flex-row justify-start w-full mt-0">
        ...
        <div className="text-white w-full text-right mt-8 lg:mt-0 lg:ml-8">
          <h1
            className="flex justify-end mb-8 text-5xl lg:text-9xl xl:text-9xl pr-80 mt-8"
            style={{
          ...
          <p
            className="flex justify-end text-xl lg:text-3xl leading-relaxed font-light w-3/4 text-right"
          ...
          <div className="flex space-x-5 mt-12 pl-10 text-left">
            <div className="text-center">
              <span className="text-4xl lg:text-8xl">{countries < 10 ? `0${countries}` : countries}</span>
              <div className="text-sm lg:text-6xl">countries</div>
            </div>
            <div className="text-center">
              <span className="text-4xl lg:text-8xl">{branches < 10 ? `0${branches}` : branches}</span>
              <div className="text-sm lg:text-6xl">Branches</div>
            </div>
            <div className="text-center">
              <span className="text-4xl lg:text-8xl">{customers.toLocaleString()}</span>
              <div className="text-sm lg:text-6xl">customers</div>
            </div>
          </div>
        </div>
      </div>
      <div className="flex flex-col lg:flex-row mt-16">
        <div className="w-full lg:w-1/2 flex justify-center items-center lg:pl-20">
          <div className="text-white text-left mt-48">
            <p className="text-4xl lg:text-4xl leading-relaxed font-light">
  ...
  <div className="w-full lg:w-1/2 flex items-center lg:pr-20 justify-end pl-36 relative">
    ...
    <div className="absolute -top-20 left-0 w-16 h-16 lg:w-40 lg:h-40 animate-spin-slow">
        <Image
      ...
      <p
        className="text-4xl w-[95%] max-w-4xl lg:text-4xl leading-loose font-light mt-80"
        style={{
