...
const Navbar = () => {
  ...
  return (
    <nav className="bg-black text-white shadow-md sticky top-0 z-50 font-sans">
      ...
      <div
        className={`fixed top-0 left-0 w-3/4 sm:w-1/2 h-full bg-black text-white py-6 px-6 z-50 flex flex-col items-center justify-center space-y-6 transition-transform duration-500 ${mobileMenuOpen ? 'translate-x-0' : '-translate-x-full'} lg:hidden`}
      >
